...
<body>
    ...
    <div class="wrap-fluid">
        <div class="container-fluid paper-wrap bevel tlbr">
            ...
            <div class="content-wrap" id="orders<c:out value="${order.orderId}"/>">
                <div class="page-extra">
                    ...
                    <section class="content invoice">
                        ...
                        <div class="row no-print">
                            <div class="col-xs-12">
                                <button class="btn btn-success pull-right" onclick='deleteOrder(<c:out value="${order.orderId}"/>)'> Dispatch</button>
                            </div>
                        </div>
                    </section>
                    <!-- /.content -->
